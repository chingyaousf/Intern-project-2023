...
3.  *(Perform the Wilcoxon test between diagonal and non-diagonal values). **Wilcoxon_test_diaonal_nondiagonal_02.tx*****t** Average Wilcoxon test statistic: 66641376.968 Average Wilcoxon test p-value: 2.1638665163031885e-20 ***T_test_diaonal_nondiagonal.txt*** T-test statistic: 11.534142895142958 T-test p-value: 1.0105059138140071e-30

4.  **Goal 4:** Develop several machine learning model to identify gene expression predictive of the CRISPR_gene_depency.![](https://github.com/chingyaousf/Intern-project/blob/main/plots/intern_ML_pipeline.png?raw=true)
